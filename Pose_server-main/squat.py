...
warning_sounds = [
    "C:/Users/Pang Choi/Desktop/music/reduce_hip.mp3",
    "C:/Users/Pang Choi/Desktop/music/extend_hip.mp3"
]
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while True:
            ...
            try:
                ...
                if score > 80 and exercise_state == 1 and stage == 0:
