...
warning_sounds = [
    "C:/Users/Pang Choi/Desktop/music/widen_elbow.mp3",
    "C:/Users/Pang Choi/Desktop/music/narrow_elbow.mp3",
    "C:/Users/Pang Choi/Desktop/music/up_shoulder.mp3",
    "C:/Users/Pang Choi/Desktop/music/down_shoulder.mp3"
]
...
def compare_pose(image, angle_point, angle_user, angle_target):
    ...
    # right elbow
    if angle_user[1] < (angle_target[1] - 10):
        warning_sound_index = 0  # 경고음 인덱스를 설정합니다. (배열의 0번째 요소를 사용하려면 0으로 설정)
        sound_path = warning_sounds[warning_sound_index]  # 경고음 경로를 불러옵니다.
...
def gen_frames():
    ...
    path = "C:/Users/Pang Choi//Desktop/image/shoulderpress.jpg"
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        ...
        while True:
            ...
            try:
                ...
                # 운동 상태 분석 및 카운트
                if score < 55 and exercise_state == 0:
                    exercise_state = 1  # 초기 상태로 변경

                if score > 72 and exercise_state == 1 and stage == 0:
