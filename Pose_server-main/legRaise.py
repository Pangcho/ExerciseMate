...
warning_sounds = [
    "C:/Users/Pang Choi/Desktop/music/legraise.mp3"
]
...
def compare_pose(image, angle_point, angle_user, angle_target):
    ...
    if angle_user[4] > (angle_target[4] + 30) and angle_user[4] < (angle_target[4] + 50):
...
def gen_frames():
    ...
    path = "C:/Users/Pang Choi//Desktop/image/legraise.jpg"
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while True:
            ...
            try:
                ...
                if score < 75 and exercise_state == 0:
                    exercise_state = 1  
