...
warning_sounds = [
    "C:/Users/Pang Choi/Desktop/music/extend_ra.mp3",
    "C:/Users/Pang Choi/Desktop/music/fold_ra.mp3",
    "C:/Users/Pang Choi/Desktop/music/extend_la.mp3",
    "C:/Users/Pang Choi/Desktop/music/fold_la.mp3"
]
...
def gen_frames():
    ...
    path = "C:/Users/Pang Choi//Desktop/image/side.jpg"
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while True:
            ...
            try:
                ...
                if score < 80 and exercise_state == 0:
                    exercise_state = 1  

                if score > 95 and exercise_state == 1:
                    exercise_count += 1 
                    exercise_state = 0   
